export default function DashboardSkeleton() {
    return (
        <div className="flex flex-col gap-y-6 animate-pulse">
            ...
            {/* UserCard */}
            <div className="m-auto flex items-center justify-between rounded-[20px] px-[52px] py-[32px] w-[1052px] h-[181px] bg-white border border-gray-100">
                <div className="flex items-center gap-[38px]">
                    <div className="w-[104px] h-[117px] rounded-[10px] bg-gray-200 shrink-0" />
                    <div className="flex flex-col gap-2.5">
                        <div className="h-[22px] w-44 rounded-md bg-gray-200" />
                        <div className="h-[14px] w-56 rounded-md bg-gray-200" />
                    </div>
                </div>
                <div className="flex items-center gap-[18px]">
                    <div className="h-[14px] w-36 rounded-md bg-gray-200" />
                    <div className="w-[183px] h-[90px] rounded-[10px] bg-gray-200" />
                </div>
            </div>

            {/* Section title */}
            <div className="flex flex-col gap-1.5 px-1 m-auto w-[1052px]">
            ...
            <div className="flex gap-6 m-auto">
                ...
                <div className="bg-white rounded-[10px] px-10 pt-4 pb-6" style={{ width: 445 }}>
                    <div className="flex justify-between items-center mb-2">
                        <div className="h-[22px] w-40 rounded-md bg-gray-200" />
                    ...
                    {/* Bars */}
                    <div className="flex items-end gap-4 h-[220px] px-2 mb-3">
                ...
                <div className="bg-white rounded-[10px] px-10 pt-4 pb-6" style={{ width: 583 }}>
                    <div className="flex justify-between items-center mb-2">
                        <div className="h-[22px] w-32 rounded-md bg-gray-200" />
                        <div className="flex gap-2 items-center">
                            <div className="h-5 w-5 rounded bg-gray-200" />
                    ...
                    {/* Double bars */}
                    <div className="flex items-end gap-3.5 h-[220px] px-2 mb-3">
            ...
            <div className="flex flex-col gap-2 m-auto w-[1052px]">
                <div className="h-5 w-40 rounded-md bg-gray-200" />
                <div className="h-3.5 w-52 rounded-md bg-gray-200" />
            </div>

            {/* RadialChartWeek */}
            <div className="flex gap-4 m-auto w-[1052px]">

                {/* Donut card */}
                <div className="bg-white rounded-2xl p-6 flex-1">
                    <div className="h-[22px] w-44 rounded-md bg-gray-200 mb-2" />
